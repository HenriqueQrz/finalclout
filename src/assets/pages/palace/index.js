    ...
    <div className='logosmarcaacesso'>
        ...
        <div className='high'>
           ...
           <div className='imagens'> 
                <img className='palacecinza' src={palacecinza} />
                <img className= 'palacerefletiva' src= {palacerefletiva}/>
                <img className='palacestussy' src= {palacestussy}/>
            </div>

            <div className='nomes' >
                <p className='cm1'> PALACE - Camiseta Cinza "SF" </p>
                <p className='cm2' > PALACE - Camiseta Preta "Refletiva"</p>
                <p className='cm3' >  PALACE - PALACE x STUSSY "st"</p>
