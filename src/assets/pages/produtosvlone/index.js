...
import vloneroxa from "../../image/vloneroxa.jpg"
import vlonelaranja from "../../image/vlonelaranja.jpg"
import vlonewoo from "../../image/vlonewoo.jpg"
...
<div className='principal'>
    ...
    <div className="text">
      <input type='text' placeholder='EX: VLONE'/>
    </div>
  ...
  <img src={highlogo} onClick={high} />
        ...
        <div className='high'>
           ...
           <div className='imagens'> 
                <img className='vlonelaranja' src={vlonelaranja} />
                <img className= 'vloneroxa' src= {vloneroxa}/>
                <img className='vlonewoo' src= {vlonewoo}/>
            </div>

            <div className='nomes' >
                <p className='cm1vlone'> VLONE - Camiseta Orange "Neon" </p>
                <p className='cm2vlone' > VLONE - x PalmAngels "Purple"</p>
                <p className='cm3vlone' >  Vlone - Camiseta White "TheWoo"</p>
