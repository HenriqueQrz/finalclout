...
import asscamarela from "../../image/asscamarela.jpg"
import asscazul from "../../image/asscazul.jpg"
import asscfaze from "../../image/asscfaze.jpg"

function Consultaassc() 
{
    ...
    <div className='logosmarcaacesso'>
        ...
        <div className='high'>
           ...
           <div className='imagens'> 
                <img className='palacecinza' src={asscamarela} />
                <img className= 'palacerefletiva' src= {asscazul}/>
                <img className='palacestussy' src= {asscfaze}/>
            </div>

            <div className='nomes' >
                <p className='cm1SUF'> ASSC - Anti social x Fragnant  "Yellow" </p>
                <p className='cm2sup' > ASSC - Anti social x Fragnant  "Blue"</p>
                <p className='cm3sup' >  ASSC - Anti social x FaZeClan "Red"</p>
            ...
            <div className='nomes2'>
                ...
                <p className='cm4' > R$299,99 </p>
                <p className='cm5' > R$299,99 </p>
                <p className='cm6' > R$299,99 </p>
