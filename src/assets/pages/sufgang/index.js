    ...
    <div className='logosmarcaacesso'>
        ...
        <div className='high'>
           ...
           <div className='imagens'> 
                <img className='palacecinza' src={suflaranja} />
                <img className= 'palacerefletiva' src= {sufwhite}/>
                <img className='palacestussy' src= {calcasuf}/>
            </div>

            <div className='nomes' >
                <p className='cm1SUF'> SUFGANG - DARK ORANGE  "Joker" </p>
                <p className='cm2' > SUFGANG - Camiseta Branca "Basic"</p>
                <p className='cm3SUF' >  SUFGANG - SUF x CHAMPION "KIDZ"</p>
...
export default Consultasufgang;
